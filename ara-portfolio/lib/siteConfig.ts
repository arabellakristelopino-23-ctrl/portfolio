...
export const siteConfig = {
  ...
  hero: {
    intro:
      "3rd-year CPU student blending joyful UI with reliable full stack engineering.",
    callouts: [
  ...
  about: {
    paragraphs: [
      "Hey there! I'm Ara, a third-year IT student at Central Philippine University who fell in love with design systems before I ever wrote my first component. I thrive at the intersection of playful UI and thoughtful engineering.",
    ...
    highlights: [
      "3rd-year BSIT · Central Philippine University",
